...
in mkModule {
  ...
  hm = cfg: {
    ...
    programs.nixcord = {
      enable = true;
      quickCss = (if config.modules.colorscheme.catppuccin.enable then
        ''
          import url("https://catppuccin.github.io/discord/dist/catppuccin-mocha.theme.css");''
      else
        "") + builtins.readFile (builtins.fetchurl {
          url =
            "https://gist.githubusercontent.com/altacountbabi/fbb93e52946c2571b678119e0f4f8b69/raw/88c3951022b2763bf4f7680494ceaf4008503c40/style.css";
          sha256 =
            "5acf36750b807d6a78c4b66b1259ec8a7243e64dfce8ca2c8982676c76c8ba6c";
        });

      discord.openASAR.enable =
        false; # OpenASAR seems to be missing some kind of module, maybe I'll figure it out later.
      config = {
        useQuickCss = true;
        frameless = true;
        plugins = {
